...
| ------------ | ------------------- | -------------------------- | -------------------------- | --------------- | ------- |
| POST         | auth/users/register | user (instructor /student) | Authorization Bearer TOKEN | register user   | public  |
| POST         | auth/users/login    | user login info            | Authorization Bearer TOKEN | Login User      | public  |
